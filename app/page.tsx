...
export default function ProductsPage() {
  ...
  const fetchProducts = async () => {
    try {
      setLoading(true);
      const res = await fetch('https://fetct-api-rest.vercel.app/API/products', { cache: 'no-store' });
  ...
  const handleAddProduct = async (e: React.FormEvent) => {
    ...
    try {
      setSubmitting(true);
      const res = await fetch('https://fetct-api-rest.vercel.app/API/products', {
        method: 'POST',
  ...
  const handleDeleteProduct = async (id: string | number) => {
    ...
    try {
      const res = await fetch(`https://fetct-api-rest.vercel.app/API/products/${id}`, {
        method: 'DELETE',
      });
      const json = await res.json();
      if (json.success) {
